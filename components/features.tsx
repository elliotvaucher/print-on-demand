          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Notre solution</h3>
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Trouvez votre voie</div>
                    <div className="text-gray-600">Découvrez vos talents et passions uniques pour vous aligner avec la mission de votre vie.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Transformez vos idées en projets</div>
                    <div className="text-gray-600">Transformez vos idées innovantes en projets concrets et actionnables.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Apprenez à monétiser vos talents</div>
                    <div className="text-gray-600">Transformez vos projets en produits commercialisables qui font une vraie différence.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
